-- This script loads all ReplicatedFirst LocalScripts into the service. --

local Player = game:GetService("Players").LocalPlayer

--debug.profilebegin("ReplicatedFirstLoad - ".. Player.Name)
...
for _, item in pairs(script:GetChildren()) do
	xpcall(function()
		item.Parent = game:GetService("ReplicatedFirst")
...
warn("Finished loading ReplicatedFirst scripts! - ".. Player.Name)
